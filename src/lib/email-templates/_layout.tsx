          ...
          <Section style={content}>
            ...
            {signatureRole ? (
              <Text style={signature}>
                ...
                L'équipe {signatureRole} — BISP × France Uniformes
              </Text>
            ) : null}
          </Section>
          <Section style={footer}>
            <Text style={footerText}>BISP — Bilingual International School of Paris</Text>
            <Text style={footerSmall}>
              Boutique d'uniformes opérée par France Uniformes.
              <br />
