...
function PasswordResetEmail({ link = '#' }: Props) {
  return (
    <EmailLayout preview="Réinitialisation de votre mot de passe" title="Réinitialisation du mot de passe" signatureRole="Boutique">
      ...
      <Text style={text}>Vous avez demandé à réinitialiser votre mot de passe sur la boutique BISP. Cliquez sur le bouton ci-dessous pour en définir un nouveau :</Text>
...
export const template = {
  ...
  previewData: { link: 'https://bisp.franceuniformes.fr/reset-password?token=xxx' },
