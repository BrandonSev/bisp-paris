...
const STATUS_LABELS: Record<string, { title: string; body: string }> = {
  ...
  'Disponible au retrait': { title: 'Commande disponible', body: "Votre commande est disponible à l'école BISP." },
...
export const template = {
  ...
  previewData: { prenom: 'Marie', familyName: 'Dupont', orderNumber: 'BISP-2026-0042', status: 'Paiement validé' },
