...
function CgvPage() {
  return (
    <LegalPageShell title="Conditions Générales de Vente — Familles" updatedAt="mai 2026">
      ...
      <p>
        Les produits proposés à la vente sont des uniformes et vêtements scolaires dont les modèles et tarifs ont
        été validés par l'établissement scolaire partenaire concerné. France Uniformes s'engage à privilégier la
        fabrication française pour l'ensemble de sa gamme.
      </p>
      <p>
        La mention « Fabrication française » figurant sur les étiquettes et fiches produits atteste que la coupe et
        la confection du vêtement sont réalisées dans des ateliers situés en France. Pour certaines pièces, d'autres
      ...
      <p>
        L'origine de fabrication de chaque article est indiquée sur sa fiche produit. Dans le cas où un article
        serait confectionné hors de France — notamment pour répondre à des besoins spécifiques de trousseau ou à des
        contraintes techniques particulières — cette information est explicitement mentionnée sur la fiche produit
        concernée.
      </p>
      <p>En validant une commande, le Client reconnaît avoir pris connaissance des présentes CGV et les accepter sans réserve.</p>
      ...
      <p>
        ...
        partenaire. Les photographies et descriptions sont données à titre illustratif et peuvent légèrement
        différer du produit final sans que cela constitue un défaut.
      </p>
      <h3>3.2 Disponibilité</h3>
      <p>
        Les produits sont fabriqués à la commande dans des ateliers français partenaires de France Uniformes. Ils
        ne sont pas stockés en quantité illimitée. France Uniformes se réserve le droit de limiter les quantités
      ...
      <p>
        ...
        résultant de mesures inexactes ou d'une évolution morphologique de l'enfant depuis la dernière mise à jour
        des mensurations.
      </p>
      ...
      <p>
        La commande est réalisée en ligne via la plateforme boutique. Elle est définitivement enregistrée et
        transmise en fabrication uniquement après :
      </p>
      <ul>
      ...
      <p>
        ...
        possible après validation du paiement, sauf dans les cas prévus à l'article 8 (droit de rétractation) ou en
        cas de défaut avéré du produit (article 9).
      </p>
      ...
      <p>
        ...
        moment de la commande. France Uniformes se réserve le droit de modifier ses tarifs à tout moment, notamment
        en raison de l'évolution du coût des matières premières, des conditions de fabrication ou de toute autre
        ...
        boutique sont susceptibles d'évoluer sans préavis. Seul le prix affiché au moment de la validation du
        panier fait foi.
      </p>
      ...
      <p>
        <strong>Expédition individuelle au domicile :</strong> des frais de port et d'emballage s'ajoutent au prix
        du produit. Leur montant est calculé et affiché au moment de la commande, avant validation du paiement.
      </p>

      <h2>6. Paiement</h2>
      <h3>6.1 Modalités</h3>
      <p>
        Le paiement s'effectue en ligne par carte bancaire via le prestataire de paiement sécurisé PayPlug. Le
        débit est effectué au moment de la validation de la commande.
      </p>
      <p>
      ...
      <p>
        En cas d'échec ou de refus du paiement, la commande n'est pas enregistrée et aucune fabrication n'est
        lancée. Le Client est invité à renouveler sa tentative de paiement.
      </p>
      ...
      <p>
        ...
        Uniformes et l'établissement scolaire partenaire. Elles sont indiquées sur la boutique concernée au moment
        de la commande et peuvent inclure :
      </p>
      <ul>
        <li>
        ...
        <li>
          <strong>Précommande groupée :</strong> les commandes sont regroupées et la fabrication est lancée une
          fois un seuil de commandes atteint. Le Client est informé du délai prévisionnel de livraison au moment
          de la commande.
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Délai de fabrication standard :</strong> 10 à 12 semaines à compter de la date de démarrage
          effectif de la fabrication, entendue comme la date à laquelle l'ensemble des éléments nécessaires au
          lancement ont été validés : confirmation de commande, choix définitif des coloris, matières et tissus, et
          validation des bons à tirer (BAT) le cas échéant. Tout retard dans la transmission ou la validation de
          ces éléments par l'établissement ou la famille entraîne un décalage équivalent du délai de fabrication.
        </li>
        <li>
          <strong>Périodes de fermeture :</strong> nos ateliers, comme la quasi-totalité des ateliers de confection
          français et européens, sont fermés pendant les principales périodes de congés (notamment les trois
          premières semaines d'août, les vacances scolaires d'hiver, ainsi que les jours fériés et ponts). Ces
          périodes ne sont pas comptabilisées dans le délai de fabrication et peuvent allonger le délai total de
          livraison.
        </li>
        <li>
          <strong>Délai réduit :</strong> si le produit commandé est disponible en stock, le délai peut être
          ramené à 1 à 2 semaines, voire moins selon les capacités disponibles au moment de la commande.
        </li>
      </ul>
      ...
      <p>
        ...
        spécifications validées par l'établissement scolaire partenaire (modèles, coloris, broderies spécifiques)
        et sont nettement personnalisés au sens de la loi : ils ne peuvent être ni revendus ni réaffectés à un
        autre établissement.
      </p>
      <p>
      ...
      <p>
        ...
        remèdes sont impossibles ou disproportionnés, le Client peut obtenir une réduction du prix ou la résolution
        du contrat.
      </p>
      ...
      <p>
        En cas de problème constaté sur un article reçu (malfaçon, erreur d'expédition, article manquant, défaut
        de couture, etc.) :
      </p>
      <ul>
      ...
      <p>Le transfert de propriété et de risques intervient à la livraison effective de l'article au Client.</p>
      ...
      <p>
        Les données personnelles collectées dans le cadre de la commande (nom, adresse, e-mail, informations
        enfant) sont traitées par France Uniformes pour les finalités suivantes : traitement de la commande,
        relation client, respect des obligations légales. Pour exercer vos droits, consultez notre{" "}
        <Link to="/aide/confidentialite">Politique de confidentialité</Link> ou contactez :{" "}
      ...
      <p>
        ...
        <strong>CM2C — Centre de Médiation de la Consommation de Conciliateurs de Justice</strong>, 49 rue de
